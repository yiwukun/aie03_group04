...
# python main.py --dataset RAD --input_height=501 --output_height=501 --batch_size=61 --is_train True
# python main.py --dataset faces_ --input_height=96 --output_height=96 --is_train True
