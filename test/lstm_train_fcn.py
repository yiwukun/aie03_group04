...
import numpy as np
from convLSTM.utils.networks import class_net_fcn_2p_lstm
from convLSTM.utils.networks import class_net_fcn_1p_lstm
#from convLSTM.utils.data_preprocesing import load_data, list_sequences, load_splits
...
if __name__ == '__main__':
    ...
    network(input_shape = (4, 500, 500, 3))
    #print(network)
